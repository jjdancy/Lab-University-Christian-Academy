    ...
    <section className="border-b border-white/10 bg-black py-16 md:py-24">
      <div className="mx-auto flex max-w-6xl flex-col gap-10 px-4 md:flex-row md:items-center md:gap-14 md:px-6">
        ...
        <div className="grid w-full shrink-0 grid-cols-2 gap-3 md:w-[360px]">
          <div className="relative h-40 overflow-hidden rounded-xl border border-yellow-500/30 md:h-[160px]">
            <img
          ...
          <div className="relative h-40 overflow-hidden rounded-xl border border-white/15 md:h-[160px]">
            <img
          ...
          <div className="relative h-40 overflow-hidden rounded-xl border border-white/15 md:h-[160px]">
            <img
              src="/images/Girls%20varsity.jpeg"
        ...
        <div className="flex-1 space-y-5">
          ...
          <p className="text-base leading-relaxed text-white/70 md:text-lg">
            National and regional teams, boys and girls varsity, and a daily
